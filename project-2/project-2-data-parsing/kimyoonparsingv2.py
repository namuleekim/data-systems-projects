...
def main():
    ...
    print('>>>(1/6)Motor_Vehicle_Collisions_-_Crashes.csv \n', dataframe_1, '\n')
    dataframe_2 = csv_to_dataframe('Motor_Vehicle_Collisions_-_Vehicles.csv')
    print('>>>(2/6)Motor_Vehicle_Collisions_-_Vehicles.csv \n', dataframe_2, '\n')
    dataframe_3 = csv_to_dataframe('Motor_Vehicle_Collisions_-_Person.csv')
    print('>>>(3/6)Motor_Vehicle_Collisions_-_Person.csv \n', dataframe_3, '\n')
    dataframe_4 = csv_to_dataframe(
        'NYSERDA_Electric_Vehicle_Drive_Clean_Rebate_Data__Beginning_2017.csv'
        )
    print(
        '>>>(4/6)NYSERDA_Electric_Vehicle_Drive_Clean_Rebate_Data__Beginning_2017.csv \n',
        dataframe_4,
        '\n')
    dataframe_5 = json_to_dataframe('Air_Quality.json')
    print('>>>(5/6)Air_Quality.json \n', dataframe_5, '\n')
    dataframe_6 = csv_to_dataframe('Vehicle__Snowmobile__and_Boat_Registrations.csv')
    print('>>>(6/6)Vehicle__Snowmobile__and_Boat_Registrations.csv \n', dataframe_6, '\n')
